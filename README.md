...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'n'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-n@main/recipes/<cuisine>/<diet>/<slug>.json
```
